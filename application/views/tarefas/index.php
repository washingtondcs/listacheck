		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="btn-group hidden-print" role="group" aria-label="...">
					<a title="Adiionar novo registro" href="<?php echo site_url('tarefas/adicionar');?>"
						class="btn btn-default btn-sm"><span
						class="glyphicon glyphicon-plus"></span> Adicionar</a>
						
					 <a title="Imprimir relatorio" href="#"
						class="btn btn-default btn-sm" onClick="return print()"><span
						class="glyphicon glyphicon-print"></span> Imprimir</a>
					
					<button title="Visualizar status geral das tarefas" type="button" class="btn btn-default btn-sm"
						data-toggle="modal" data-target="#grafico">
...
foreach ( $tarefas as $tarefa_item ) :
	...
	?>></button>
							...
							href="<?php echo site_url('tarefas/delete/'.$tarefa_item['id']); ?>"
							onClick="return confirm('Deseja deletar o registro?<?php echo $tarefa_item['titulo'];?>')"><button title="Deletar tarefa"
									class="glyphicon glyphicon-remove btn btn-default"></button></a>
							<a
							href="<?php echo site_url('tarefas/editar/'.$tarefa_item['id']); ?>"><button title="Editar registro"
